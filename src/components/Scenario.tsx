...
function CardSection(props: TestimonialCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <chakra.p color={`secondary`} fontWeight={`bold`} fontSize={14}>
          {name}
          <chakra.span fontWeight={`medium`} color={`secondary`}>
            {` `}- {role}
          </chakra.span>
        </chakra.p>
      </Flex>
  ...
  return (
    ...
    >
      <Box width={{ base: `full`, sm: `lg`, lg: `xl` }} margin={`auto`}>
        ...
        <chakra.h1 py={5} fontSize={48} fontWeight={`bold`} color={`primary`}>
      ...
      >
        {testimonials.map((cardInfo, index) => (
          ...
          <CardSection {...cardInfo} index={index} />
        ))}
      </SimpleGrid>
      <Box mb={20} />
    </Flex>
